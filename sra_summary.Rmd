...
All datasets are genomic

Table with strains and reference genome accession #
...
```{r, echo =FALSE}
#loading files
files <- grep("csv",list.files(), value = T)
sra_df <- ldply(files,read.csv,stringsAsFactors=F,header=T)
